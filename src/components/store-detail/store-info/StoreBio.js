...
export class StoreBio extends Component {
  state = {
    store: {
      ...
      image_url:
        "https://cdn.i-scmp.com/sites/default/files/styles/1200x800/public/d8/images/methode/2019/09/28/70b04c7a-ddc7-11e9-94c8-f27aa1da2f45_image_hires_132637.jpg"
    }
  };
            ...
            <Col span={18}>
              ...
              <Row>
                <p style={{ color: "#0F4C81" }}>
                  {this.state.store.store_Description}
                </p>
              </Row>
            </Col>
            <Col span={6}>
